...
/******/ 	return __webpack_require__(__webpack_require__.s = "./items.js");
/******/ })
/************************************************************************/
/******/ ({
...
function create_basket_card(content, data) {
  ...
  basket_summ.textContent = data.prices.price_with_discount_with_attributes + '' + data.chosen_currency; // basket_summ.textContent = data.item.price + ' ' + data.item.currency.code;
...
/***/ "../components/pages/items/index.js":
/*!******************************************!*\
  !*** ../components/pages/items/index.js ***!
  \******************************************/
/*! no exports provided */
...
function cardNew1(bodyCar) {// var fragment = document.createDocumentFragment();
  // var cur_step = 0;
  // console.log(bodyCar);
...
function get_user_cart_generate() {
  ...
  fetch("/api/items/?per_page=6&page_number=".concat(page_number, "&category_id=").concat(category_id, "&max_price=").concat(val_floor2, "&min_price=").concat(val_floor1, "&category_ids=").concat(JSON.stringify(per_arr)), {
    ...
    for (var key in body.results) {
      removeBtn++; // console.log('fixed_count: ', fixed_count);
...
function createProdCard(product, step) {
  ...
  var card_prof = document.createElement('a');
  card_prof.style.setProperty('animation-delay', step + 's'), card_prof.classList.add('product_card-prof');
  ...
  prod_card_cost.textContent = "".concat(product.price, " ").concat(product.currency.code);
  ...
  prod_card_basket.setAttribute('src', '/static/source/img/items/okey.svg'); // var window_lang = window.location.pathname.split('/')[1];
  ...
  link_wrap.appendChild(prod_img); // card_prof.appendChild(prod_name);
...
/***/ "../components/pages/items/index.scss":
/*!********************************************!*\
  !*** ../components/pages/items/index.scss ***!
  \********************************************/
/*! no static exports found */
...
/* harmony import */ var _components_pages_items_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/pages/items/index */ "../components/pages/items/index.js");
// script interface
