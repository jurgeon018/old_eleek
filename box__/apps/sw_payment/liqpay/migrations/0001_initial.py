    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liqpay_public_key', models.TextField(default='sdf', verbose_name='Публічний ключ')),
                ('liqpay_private_key', models.TextField(default='sdf', verbose_name='Приватний ключ')),
                ('liqpay_sandbox_public_key', models.TextField(default='sdf', verbose_name='Тестовий публічний ключ')),
                ('liqpay_sandbox_private_key', models.TextField(default='sdf', verbose_name='Тестовий приватний ключ')),
                ('sandbox_mode', models.BooleanField(default='sdf', verbose_name='Тестовий режим')),
            ],
            options={
